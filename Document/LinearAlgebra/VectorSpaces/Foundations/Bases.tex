...
\begin{example}[Standard Bases]\label{ex:standard-bases}
    ...
    \begin{enumerate}
        ...
        \item $\{e_0, \ldots, e_{n-1}\}$ is the standard basis for $K^n$
    \end{enumerate}
    ...
    \begin{tikzpicture}[scale=1.0, >=stealth]
        ...
        \begin{scope}
            ...
            \draw[->, very thick, blue] (0,0) -- (1,0) node[below right] {$e_0$};
            \draw[->, very thick, red] (0,0) -- (0,1) node[above left] {$e_1$};
...
\begin{example}[Bases in $\bb{R}^3$]\label{ex:bases-R3}
    ...
    \begin{itemize}
        \item $\{e_0, e_1, e_2\} = \{(1,0,0), (0,1,0), (0,0,1)\}$ --- standard basis
    ...
    \begin{itemize}
        \item $\{e_0, e_1, e_2, (1,1,1)\}$ --- 4 vectors in $\bb{R}^3$, so dependent
    \end{itemize}

    \textbf{Not a basis (independent but not spanning)}:
    \begin{itemize}
        \item $\{e_0, e_1\}$ --- only spans the $xy$-plane, not all of $\bb{R}^3$
    \end{itemize}
    ...
    \begin{tikzpicture}[scale=1.0,
        ...
        \draw[->, very thick, blue] (0,0,0) -- (1.5,0,0) node[right] {$e_0$};
        \draw[->, very thick, red] (0,0,0) -- (0,1.5,0) node[above right] {$e_1$};
        \draw[->, very thick, green!60!black] (0,0,0) -- (0,0,1.5) node[above] {$e_2$};
...
\begin{proposition}[Dimensions of Finite-Dimensional Spaces]\label{prop:dim-finite}
    The following hold:
    \begin{enumerate}
        \item $\Dim[K]{K^n} = n$, since $\{e_0, \ldots, e_{n-1}\}$ is a basis.
...
\begin{proof}
    ...
    span $K^n$ (any $(a_0, \ldots, a_{n-1}) = \sum_{i \in n} a_i e_i$) and are linearly independent
...
\begin{proof}
    By Corollary~\ref{cor:direct-sum-dim}:
    $\Dim[K]{V} = \Dim[K]{U} + \Dim[K]{W_1} = \Dim[K]{U} + \Dim[K]{W_2}$.
    Thus $\Dim[K]{W_1} = \Dim[K]{V} - \Dim[K]{U} = \Dim[K]{W_2}$.
\end{proof}
