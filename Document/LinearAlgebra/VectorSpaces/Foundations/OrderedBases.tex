...
\begin{example}[Coordinate Dependence on Ordering]\label{ex:coord-ordering}
    ...
    \begin{itemize}
        \item $\mathcal{B}_1 = (e_0, e_1)$: $\CoordVec[\mathcal{B}_1]{v} = \begin{pmatrix} 3 \\ 2 \end{pmatrix}_{\mathcal{B}_1}$
        \item $\mathcal{B}_2 = (e_1, e_0)$: $\CoordVec[\mathcal{B}_2]{v} = \begin{pmatrix} 2 \\ 3 \end{pmatrix}_{\mathcal{B}_2}$
    \end{itemize}
