...
\begin{example}[Linear Independence and Dependence]\label{ex:lin-indep-dep}
    ...
    \begin{itemize}
        ...
        \item $\{1, X, X^2\}$ in $K[X]$
        \item $\{e_0, e_1, e_2\}$ (standard basis) in $\bb{R}^3$
    \end{itemize}
...
\begin{example}[Linear Independence in $\bb{R}^3$]\label{ex:lin-indep-R3}
    ...
    \begin{itemize}
        \item $\{e_0, e_1, e_2\} = \{(1,0,0), (0,1,0), (0,0,1)\}$ --- the standard basis
        \item $\{(1, 0), (1, 1)\}$ --- linearly independent, alternative basis for $\bb{R}^2$
        \item $\{(1,1,0), (1,0,1), (0,1,1)\}$ --- three non-coplanar vectors
    \end{itemize}

    \textbf{Dependent (more than $\dim = 3$ vectors)}:
    \begin{itemize}
        \item $\{e_0, e_1, e_2, (1,1,1)\}$ --- any 4 vectors in $\bb{R}^3$ are dependent
    \end{itemize}
...
\begin{example}[Dependence Examples]\label{ex:dependence}
    In $\bb{R}^3$ with standard basis $\{e_0, e_1, e_2\}$:
    \begin{itemize}
        \item $(1, 2, 3)$ is linearly dependent on $\{e_0, e_1, e_2\}$ because
              $(1, 2, 3) = 1 \cdot e_0 + 2 \cdot e_1 + 3 \cdot e_2 \in \Span[\bb{R}]{\{e_0, e_1, e_2\}}$.
        \item $e_0$ is linearly \emph{independent} of $\{e_1, e_2\}$ because
              $e_0 = (1, 0, 0) \notin \Span[\bb{R}]{\{e_1, e_2\}} = \Set{(0, y, z) \mid y, z \in \bb{R}}$.
    \end{itemize}
\end{example}
...
\begin{proof}
    ...
    Then $\ell_0 = -\frac{1}{a_0}\sum_{i=1}^{n-1} a_i \ell_i \in \Span[K]{L \setminus \{\ell_0\}}$,
    contradicting (i').
