...
\begin{proposition}[Basic Properties of Linear Maps]\label{prop:linear-map-basic}
    ...
    \begin{enumerate}
        ...
        \item $T\left(\sum_{i=1}^{n} a_i u_i\right) = \sum_{i=1}^{n} a_i T(u_i)$ for any finite linear combination
    \end{enumerate}
\end{proposition}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \begin{scope}
            ...
            \draw[->, thick, red] (0,0) -- (1,0) node[midway, below] {$e_1$};
            \draw[->, thick, green!50!black] (0,0) -- (0,1) node[midway, left] {$e_2$};
            \node[below] at (1,-0.8) {Basis $B = \{e_1, e_2\}$};
        \end{scope}
        ...
        \begin{scope}[xshift=6cm]
            ...
            \draw[->, thick, red] (0,0) -- (2,0) node[midway, below] {$f(e_1)$};
            \draw[->, thick, green!50!black] (0,0) -- (0.5,1.5) node[midway, left] {$f(e_2)$};
            \node[below] at (1.25,-0.8) {Target $W$};
        \end{scope}
    \end{tikzpicture}
    \caption{The universal property in action: specifying $f(e_1)$ and $f(e_2)$ uniquely determines the linear map $T$.
    The unit square spanned by $\{e_1, e_2\}$ maps to the parallelogram spanned by $\{f(e_1), f(e_2)\}$.}
...
\begin{corollary}[Linear Maps Determined by Basis Values]\label{cor:linear-map-basis}
    ...
    determined by the images of the standard basis vectors $T(e_1), \ldots, T(e_n) \in K^m$.
\end{corollary}
...
\begin{proof}
    ...
    Then $u = \sum_{i=1}^{n} a_i s_i$ for some $a_i \in K$, $s_i \in S$.
    By linearity:
    \[
        v = T(u) = T\left(\sum_{i=1}^{n} a_i s_i\right) = \sum_{i=1}^{n} a_i T(s_i) \in \Span[K]{\DirectImage{T}{S}}
    \]
