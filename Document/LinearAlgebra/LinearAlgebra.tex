% Document/LinearAlgebra/LinearAlgebra.tex

\part{Linear Algebra}

\par Linear algebra is the branch of mathematics that studies vectors, linear transformations, and systems of linear equations. We will first define the fundamental concepts.
