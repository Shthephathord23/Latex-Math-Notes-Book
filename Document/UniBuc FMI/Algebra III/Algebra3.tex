...
\begin{definition}[Primes and Irreductibles in Integral Domains]
    ...
    \begin{enumerate}
        \item An element $p \in A$ is called \textbf{prime} if $p \notin U(A) \cup {0}$ and \[\Forall :{a, b \in A}{p \mid ab \implies p \mid a \LogicOr p \mid b}\]
        
        \item An element $r \in A$ is called \textbf{irreducible} if $r \notin U(A) \cup {0}$ and \[\Forall :{a, b \in A}{r = ab \implies a \in U(A) \LogicOr b \in U(A)}\]
    \end{enumerate}
...
\begin{proof}[Proof of Remark 1]
    ...
    Since $r$ is irreducible, by definition we have $a \in U(A) \LogicOr b \in U(A)$.
...
\begin{proof}[Proof of Remark 2]
    ...
    By definition, $p \notin U(A) \cup \{0\}$. Now suppose $p = ab$ for some $a, b \in A$. We need to show that $a \in U(A) \LogicOr b \in U(A)$.
    
    Since $p = ab$, we have $p \mid ab$. Since $p$ is prime, by definition $p \mid a \LogicOr p \mid b$.
    ...
    In either case, $a \in U(A) \LogicOr b \in U(A)$, which shows that $p$ is irreducible.
\end{proof}
...
\begin{proof}
    ...
    Let $r$ be an irreducible element in $A$. We need to show that $r$ is prime, i.e., $\Forall :{a, b \in A}{r \mid ab \implies r \mid a \LogicOr r \mid b}$.
    ...
    In either case, $r \mid a \LogicOr r \mid b$, which shows that $r$ is prime.
\end{proof}
