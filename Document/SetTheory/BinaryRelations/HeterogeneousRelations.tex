...
\[ \Forall :{a \in A}{\Forall :{b_1, b_2 \in B}{(a, b_1) \in R \LogicAnd (a, b_2) \in R \implies b_1 = b_2}} \]
...
\[ \Forall :{b \in B}{\Forall :{a_1, a_2 \in A}{(a_1, b) \in R \LogicAnd (a_2, b) \in R \implies a_1 = a_2}} \]
...
\[ \Forall :{b \in B}{\Forall :{a_1, a_2 \in A}{(b, a_1) \in \ConverseRel{R} \LogicAnd (b, a_2) \in \ConverseRel{R} \implies a_1 = a_2}} \]
...
($\Rightarrow$) Assume $r$ is univalent. Let $(b_1, b_2) \in \Composition{R}{\ConverseRel{R}}$. Then $\Exists :p{a \in A}{(b_1, a) \in \ConverseRel{R} \LogicAnd (a, b_2) \in R}$, which means $\Exists :p{a \in A}{(a, b_1) \in R \LogicAnd (a, b_2) \in R}$. Since $r$ is univalent, we have $b_1 = b_2$. Therefore $(b_1, b_2) = (b_1, b_1) \in \Identity{B}$, so $\Composition{R}{\ConverseRel{R}} \subseteq \Identity{B}$.
...
($\Leftarrow$) Assume $\Composition{\ConverseRel{R}}{R} \supseteq \Identity{A}$. Let $a \in A$ be arbitrary. Then $(a, a) \in \Identity{A} \subseteq \Composition{\ConverseRel{R}}{R}$. By definition of composition, $\Exists :p{b \in B}{(a, b) \in R \LogicAnd (b, a) \in \ConverseRel{R}}$. Since $(b, a) \in \ConverseRel{R}$ is equivalent to $(a, b) \in R$, the first condition already gives us $(a, b) \in R$ for some $b \in B$. Therefore $r$ is total.

\textbf{(3) Injective}:

($\Rightarrow$) Assume $r$ is injective. Let $(a_1, a_2) \in \Composition{\ConverseRel{R}}{R}$. Then $\Exists :p{b \in B}{(a_1, b) \in R \LogicAnd (b, a_2) \in \ConverseRel{R}}$, which means $\Exists :p{b \in B}{(a_1, b) \in R \LogicAnd (a_2, b) \in R}$. Since $r$ is injective, we have $a_1 = a_2$. Therefore $(a_1, a_2) = (a_1, a_1) \in \Identity{A}$, so $\Composition{\ConverseRel{R}}{R} \subseteq \Identity{A}$.
...
($\Leftarrow$) Assume $\Composition{R}{\ConverseRel{R}} \supseteq \Identity{B}$. Let $b \in B$ be arbitrary. Then $(b, b) \in \Identity{B} \subseteq \Composition{R}{\ConverseRel{R}}$. By definition of composition, $\Exists :p{a \in A}{(b, a) \in \ConverseRel{R} \LogicAnd (a, b) \in R}$. Since $(b, a) \in \ConverseRel{R}$ is equivalent to $(a, b) \in R$, the second condition already gives us $(a, b) \in R$ for some $a \in A$. Therefore $r$ is surjective.
\end{proof}
...
\textit{(Binary Intersection $\implies$ Univalent):} Assume $\InverseImage{r}{B_1 \cap B_2} = \InverseImage{r}{B_1} \cap \InverseImage{r}{B_2}$ for all $B_1, B_2$. Suppose $r$ is not univalent. Then $\Exists :p{x, y_1, y_2}{(x, y_1) \in R \LogicAnd (x, y_2) \in R \LogicAnd y_1 \neq y_2}$. 
...
Assume $\Composition{s}{r}$ is total. Let $a \in A$ be arbitrary. Since $\Composition{s}{r}$ is total, $\Exists :{c \in C}{(a, c) \in \Composition{S}{R}}$. By definition of composition, $\Exists :{b \in B}{(a, b) \in R \LogicAnd (b, c) \in S}$. Thus $\Exists :{b \in B}{(a, b) \in R}$, so $r$ is total.
