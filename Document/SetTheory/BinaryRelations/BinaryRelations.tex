...
\begin{definition}[Binary Relations and Graphs of Binary Relations]2
...
&\Leftrightarrow y = x \LogicAnd y \in A \\
&\Leftrightarrow x = y \LogicAnd x \in A \\
...
For the universal relation: $(x, y) \in \ConverseRel p{A \times B} \Leftrightarrow (y, x) \in A \times B \Leftrightarrow y \in A \LogicAnd x \in B \Leftrightarrow (x, y) \in B \times A$.
\end{proof}
...
\[
\Composition{S}{R} \defeq \left\{ (a, c) \mid \Exists vp{b}{(a, b) \in R \LogicAnd (b, c) \in S} \right\}
\]
\end{definition}
...
\begin{enumerate}
    ...
    \item $\Composition{S}{R} = \{(a,c) \mid \Exists :  {b \in \Range{R} \cap \Domain{S}}{(a,b) \in R \LogicAnd (b,c) \in S}\}$
...
\begin{proof}
\textbf{(1)} Let $a \in \Domain{\Composition{S}{R}}$. Then $\Exists{c}{(a,c) \in \Composition{S}{R}}$, so $\Exists{b}{(a,b) \in R \LogicAnd (b,c) \in S}$. Thus $a \in \Domain{R}$.

\textbf{(2)} Let $c \in \Range{\Composition{S}{R}}$. Then $\Exists{a}{(a,c) \in \Composition{S}{R}}$, so $\Exists{b}{(a,b) \in R \LogicAnd (b,c) \in S}$. Thus $c \in \Range{S}$.

\textbf{(3)} By definition:
\[
\Composition{S}{R} = \left\{ (a,c) \mid \Exists vp{b}{(a,b) \in R \LogicAnd (b,c) \in S} \right\}
\]
If $(a,b) \in R$ then $b \in \Range{R}$, and if $(b,c) \in S$ then $b \in \Domain{S}$. Thus:
\[
\Exists vp{b}{(a,b) \in R \LogicAnd (b,c) \in S} \Leftrightarrow \Exists :{b \in \Range{R} \cap \Domain{S}}{(a,b) \in R \LogicAnd (b,c) \in S}
\]
...
&\Leftrightarrow \Exists vp{b}{(a,b) \in R \LogicAnd (b,d) \in \Composition{T}{S}} \\
&\Leftrightarrow \Exists vp{b}{(a,b) \in R \LogicAnd \Exists vp{c}{(b,c) \in S \LogicAnd (c,d) \in T}} \\
&\Leftrightarrow \Exists vp{c}{\Exists vp{b}{(a,b) \in R \LogicAnd (b,c) \in S} \LogicAnd (c,d) \in T} \\
&\Leftrightarrow \Exists vp{c}{(a,c) \in \Composition{S}{R} \LogicAnd (c,d) \in T} \\
...
&\Leftrightarrow \Exists vp{x}{(a,x) \in \Identity{A} \LogicAnd (x,b) \in R} \\
&\Leftrightarrow \Exists :p{x \in A}{a = x \LogicAnd (x,b) \in R} \\
...
&\Leftrightarrow \Exists vp{b}{(c,b) \in R \LogicAnd (b,a) \in S} \\
&\Leftrightarrow \Exists vp{b}{(b,c) \in \ConverseRel{R} \LogicAnd (a,b) \in \ConverseRel{S}} \\
...
&\Leftrightarrow \Exists vp{b}{(a,b) \in \bigcup_{i \in I} R_i \LogicAnd (b,c) \in S} \\
&\Leftrightarrow \Exists vp{b}{\left( \Exists :{i \in I}{(a,b) \in R_i} \right) \LogicAnd (b,c) \in S} \\
&\Leftrightarrow \Exists :{i \in I}{\Exists vp{b}{(a,b) \in R_i \LogicAnd (b,c) \in S}} \\
...
&\Leftrightarrow \Exists vp{b}{(a,b) \in \bigcap_{i \in I} R_i \LogicAnd (b,c) \in S} \\
&\Leftrightarrow \Exists vp{b}{\left( \Forall :{i \in I}{(a,b) \in R_i} \right) \LogicAnd (b,c) \in S} \\
&\Rightarrow \Forall :{i \in I}{\Exists vp{b}{(a,b) \in R_i \LogicAnd (b,c) \in S}} \\
...
&\Leftrightarrow \Exists vp{b}{(a,b) \in R_1 \LogicAnd (b,c) \in S} \\
&\Rightarrow \Exists vp{b}{(a,b) \in R_2 \LogicAnd (b,c) \in S} \quad (\text{since } R_1 \subseteq R_2) \\
...
&\Leftrightarrow \Exists vp{b}{(a,b) \in R \LogicAnd (b,c) \in S_1} \\
&\Rightarrow \Exists vp{b}{(a,b) \in R \LogicAnd (b,c) \in S_2} \quad (\text{since } S_1 \subseteq S_2) \\
...
&\Leftrightarrow \Exists vp{b}{(a,b) \in R \LogicAnd (b,c) \in \ComplementRel {S}} \\
&\Leftrightarrow \Exists vp{b}{(a,b) \in R \LogicAnd (b,c) \notin S} \\
...
&\Leftrightarrow \Exists vp{b}{(a,b) \in \ComplementRel {R} \LogicAnd (b,c) \in S} \\
&\Leftrightarrow \Exists vp{b}{(a,b) \notin R \LogicAnd (b,c) \in S} \\
...
\begin{remark}
    ...
    \[ \Restriction{R}[A][B] \defeq \left\{ (x, y) \in R \mid x \in A \LogicAnd y \in B \right\} = R \cap (A \times B) \]
...
\textbf{(1) Restriction}: 
\begin{align*}
\Composition{R}{\Identity{A}} &= \left\{ (x, z) \mid \Exists vp{y}{(x, y) \in \Identity{A} \LogicAnd (y, z) \in R} \right\} \\
&= \left\{ (x, z) \mid \Exists :{y \in A}{x = y \LogicAnd (y, z) \in R} \right\} \\
&= \left\{ (x, z) \mid x \in A \LogicAnd (x, z) \in R \right\} \\
&= \Restriction{R}[A]
\end{align*}

\textbf{(2) Corestriction}: 
\begin{align*}
\Composition{\Identity{B}}{R} &= \left\{ (x, z) \mid \Exists vp{y}{(x, y) \in R \LogicAnd (y, z) \in \Identity{B}} \right\} \\
&= \left\{ (x, z) \mid \Exists :{y \in B}{(x, y) \in R \LogicAnd y = z} \right\} \\
&= \left\{ (x, y) \mid (x, y) \in R \LogicAnd y \in B \right\} \\
&= \Restriction{R}[][B]
\end{align*}
...
&= \left\{ (x, y) \mid (y, x) \in R \LogicAnd x \in B \right\} \\
&= \ConverseRel{\left\{ (y, x) \mid (y, x) \in R \LogicAnd x \in B \right\}} \\
...
&= \left\{ (x, y) \mid (y, x) \in R \LogicAnd y \in A \right\} \\
&= \ConverseRel{\left\{ (y, x) \mid (y, x) \in R \LogicAnd y \in A \right\}} \\
...
\input{Document/SetTheory/BinaryRelations/HeterogeneousRelations.tex}

\input{Document/SetTheory/BinaryRelations/HomogeneousRelations.tex}
